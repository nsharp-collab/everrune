...
local goal
repeat 
local ray = Ray.new(Vector3.new(origin.p.x+math.random(-tether,tether),100,origin.p.z+math.random(-tether,tether)),Vector3.new(0,-1000,0))
...
wait(1)
					...
					<string name="ScriptGuid">{5D8236F2-11A9-4065-A8E7-06D3F93DD176}
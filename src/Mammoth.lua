...
local soundBank = game.ReplicatedStorage.Sounds.NPC["Lil Banto"]:GetChildren()
...
wait(math.random(3,8))
					...
					<string name="ScriptGuid">{3157527C-33FA-4009-A370-5B5231CB8BFB}